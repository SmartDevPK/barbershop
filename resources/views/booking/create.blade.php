                                ...
                                <form action="{{ route('booking.store') }}" method="POST"
                                    ...
                                    <div class="booking-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="text" name="full_name" id="bb-name" class="form-control"
                                            ...
                                            <div class="col-lg-6 col-12">
                                                <input type="date" name="booking_date" id="bb-date" class="form-control"
                                                    placeholder="Date" required>
                                            </div>

                                            <div class="col-lg-6 col-12">
                                                <input type="number" name="number_of_people" id="bb-number"
                                                    class="form-control" placeholder="Number of People" min="1"
                                                    required>
                                            </div>
                                        </div>

                                        <textarea name="comment" rows="3" class="form-control" id="bb-message"
